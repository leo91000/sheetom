...
if (
  ...
  nativeGrammar?.valueCapabilities?.passed !== 171 ||
  nativeGrammar?.valueCapabilities?.total !== 171 ||
  nativeGrammar?.valueCapabilities?.positive !== 121 ||
  nativeGrammar?.valueCapabilities?.negative !== 50 ||
