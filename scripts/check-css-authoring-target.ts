...
try {
  ...
  const report = { browser: browser.version(), probes: corpus.probes.length, supportsChecksPerBackend: expectedSupports.length, escapeChecksPerBackend: identifiers.length, mismatches };
