...
const CONTRACT_FILES = Object.freeze([
  "scripts/build-wasm-engine.ts",
  "scripts/finalize-wasm-package.ts",
  "scripts/parameterize-wasm-bindgen.ts",
  "scripts/parameterize-wasm-facade.ts",
  "scripts/test-wasm-backend.ts",
  "scripts/test-wasm-browsers.ts",
  "scripts/test-wasm-bundlers.ts",
  "scripts/test-wasm-browser-performance.ts",
  "scripts/test-wasm-memory-soak.ts",
]);
