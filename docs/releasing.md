...
4. Review the version, changelog, npm and Cargo lockfiles, Native Engine evidence, Compatibility Report, and green release-PR CI. RC6 reports must identify the exact vendored source manifest, 129/129 shorthands, 24 codec profiles, 101/101 grammar branches, the complete native grammar corpora, all 66,123 Chromium property/value checks across 711 properties and 93 probes, and complete native/public process-safety execution.
