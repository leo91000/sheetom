...
4. Review the version, changelog, lockfile, Syntax Engine Set, Compatibility Report, and green release-PR CI. The report must identify 23 shorthand codec profiles, 92/92 passing Grammar Branch Cases, and SHA-256 hashes for both the reviewed contracts and pinned Chromium observations. Then merge the release pull request.
