...
define_properties! {
  ...
  "top": Top(AnchorSizeOrAuto) [logical_group: Inset, category: Physical],
  "bottom": Bottom(AnchorSizeOrAuto) [logical_group: Inset, category: Physical],
  "left": Left(AnchorSizeOrAuto) [logical_group: Inset, category: Physical],
  "right": Right(AnchorSizeOrAuto) [logical_group: Inset, category: Physical],
  "inset-block-start": InsetBlockStart(AnchorSizeOrAuto) [logical_group: Inset, category: Logical],
  "inset-block-end": InsetBlockEnd(AnchorSizeOrAuto) [logical_group: Inset, category: Logical],
  "inset-inline-start": InsetInlineStart(AnchorSizeOrAuto) [logical_group: Inset, category: Logical],
  "inset-inline-end": InsetInlineEnd(AnchorSizeOrAuto) [logical_group: Inset, category: Logical],
