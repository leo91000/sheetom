...
define_properties! {
  ...
  "top": Top(AnchorPositionOrAuto) [logical_group: Inset, category: Physical],
  "bottom": Bottom(AnchorPositionOrAuto) [logical_group: Inset, category: Physical],
  "left": Left(AnchorPositionOrAuto) [logical_group: Inset, category: Physical],
  "right": Right(AnchorPositionOrAuto) [logical_group: Inset, category: Physical],
  "inset-block-start": InsetBlockStart(AnchorPositionOrAuto) [logical_group: Inset, category: Logical],
  "inset-block-end": InsetBlockEnd(AnchorPositionOrAuto) [logical_group: Inset, category: Logical],
  "inset-inline-start": InsetInlineStart(AnchorPositionOrAuto) [logical_group: Inset, category: Logical],
  "inset-inline-end": InsetInlineEnd(AnchorPositionOrAuto) [logical_group: Inset, category: Logical],
  ...
  "margin-top": MarginTop(AnchorSizeOrAuto) [logical_group: Margin, category: Physical],
  "margin-bottom": MarginBottom(AnchorSizeOrAuto) [logical_group: Margin, category: Physical],
  "margin-left": MarginLeft(AnchorSizeOrAuto) [logical_group: Margin, category: Physical],
  "margin-right": MarginRight(AnchorSizeOrAuto) [logical_group: Margin, category: Physical],
  "margin-block-start": MarginBlockStart(AnchorSizeOrAuto) [logical_group: Margin, category: Logical],
  "margin-block-end": MarginBlockEnd(AnchorSizeOrAuto) [logical_group: Margin, category: Logical],
  "margin-inline-start": MarginInlineStart(AnchorSizeOrAuto) [logical_group: Margin, category: Logical],
  "margin-inline-end": MarginInlineEnd(AnchorSizeOrAuto) [logical_group: Margin, category: Logical],
